...
public class EventStorePersistenceTest {
    ...
    public void testSerialiseringAvEventer() throws IOException {
        ...
        f.deleteOnExit();
        FilehandlerEventstore eventstore = new FilehandlerEventstore(new FileHandler(f.getCanonicalPath()));
    ...
    public void testDeSerialiseringAvEventer() throws IOException {
        FilehandlerEventstore eventstore = new FilehandlerEventstore(new FileHandler("src/test/resources/EventStorePersistenceTest.txt"));
