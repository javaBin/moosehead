...
public class EmailSagaTest {
    ...
    public void shouldSendEmailOnConfirm() throws Exception {
        ...
        final ReservationAddedByUser reservationAddedByUser = new ReservationAddedByUser(System.currentTimeMillis(), 2L, "darth@a.com", "Darth", "one");
    ...
    public void shouldSendReservationConfirmation() throws Exception {
        ReservationAddedByUser reservationAddedByUser = new ReservationAddedByUser(System.currentTimeMillis(), 2L, "darth@a.com", "Darth", "one");
        emailSaga.eventAdded(reservationAddedByUser);
        emailSaga.eventAdded(new SystemBootstrapDone(1L));
    ...
    public void shouldAskForEmailConfirmationOnlyOnce() throws Exception {
        ...
        final ReservationAddedByUser reservationAddedByUser =new ReservationAddedByUser(System.currentTimeMillis(), 4L, "darth@a.com", "Darth", "two");
        emailSaga.eventAdded(reservationAddedByUser);
    ...
    public void shouldSendOneEmailForEachReservation() throws Exception {
        final ReservationAddedByUser reservationAddedByUser1 = new ReservationAddedByUser(System.currentTimeMillis(), 2L, "darth@a.com", "Darth", "one");
        final ReservationAddedByUser reservationAddedByUser2 = new ReservationAddedByUser(System.currentTimeMillis(), 4L, "darth@a.com", "Darth", "two");
    ...
    public void shouldSendConfirmationWhenPlaceBecomesAvailible() throws Exception {
        final ReservationAddedByUser reservationAddedByUser = new ReservationAddedByUser(System.currentTimeMillis(), 5L, "jarjar@a.com", "JarJar", "one");
        emailSaga.eventAdded(new ReservationAddedByUser(System.currentTimeMillis(), 2L, "darth@a.com", "Darth", "one"));
        emailSaga.eventAdded(new EmailConfirmedByUser("darth@a.com",System.currentTimeMillis(), 2L));
        emailSaga.eventAdded(new ReservationAddedByUser(System.currentTimeMillis(), 4L, "luke@a.com", "Luke", "one"));
        emailSaga.eventAdded(new EmailConfirmedByUser("luke@a.com",System.currentTimeMillis(), 2L));
